...
def checkForGreen():
    ...
    if ((avg >minAvg)and (avg < maxAvg)):
        print("Shuttle is detected")
        GPIO.output(GreenShuttlePin, GPIO.HIGH)
        time.sleep(0.5)
        GPIO.output(GreenShuttlePin, GPIO.LOW)
        return 'green'
    else:
        print("Shuttle is not detected")
        GPIO.output(RedShuttlePin, GPIO.LOW)
...
def checkForGold():
    ...
    if ((avg >minAvg)and (avg < maxAvg)):
        print("Shuttle is detected")
        GPIO.output(GoldShuttlePin, GPIO.HIGH)
        time.sleep(0.5)
        GPIO.output(GoldShuttlePin, GPIO.LOW)
        return 'green'
    else:
        print("Shuttle is not detected")
        GPIO.output(RedShuttlePin, GPIO.LOW)
